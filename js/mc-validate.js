...
(function($) {
  ...
  try {
    ...
    err_style = '#mc_embed_signup input.mce_inline_error { border-color:#C25750; } #mc_embed_signup div.mce_inline_error { margin: 0 0 1em 0; padding: 5px 10px; color: #C25750; font-weight: 400; z-index: 1; }';
  }
